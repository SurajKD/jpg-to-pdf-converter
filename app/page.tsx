...
export const metadata = {
  ...
  description: 'Convert JPG images to PDF instantly. Privacy-first, client-side conversion. No uploads required. Works on desktop, tablet, and mobile.',
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({
        ...
        "description": "Free online tool to convert JPG images to PDF documents securely in your browser",
